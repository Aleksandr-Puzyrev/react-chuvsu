...
// На любом языке программирования составить компьютер- ную программу, реализующую алгоритм Цезаря.
// Технические условия:
// зашифрование и расшифрование текстов, записанных ки- риллицей и латиницей;
// • взлом зашифрованного русскоязычного текста методом наименьших квадратов;
// • замена во вводимом тексте буквы Ё на Е;
// • очистка вводимого текста от всех небуквенных символов, знаков препинания, пробелов; приведение всех букв к строч- ному регистру;
// • приведение введенного значения ключа к диапазону [0; 32] для кириллицы, [0; 26] для латиницы;
// • выдача обработанного текста группами по пять символов; • защита от неправильных действий пользователя («дурако- устойчивость»);
